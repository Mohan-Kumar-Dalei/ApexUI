...
const NextButton = ({ to, children }) => (
    <NavLink to={to} className="next-button">
    ...
    return (
        <>
            ...
            <div className="w-screen h-screen flex flex-col text-[var(--color-text)] bg-[var(--color-bg)] relative">
                ...
                <header className="h-20 flex-shrink-0 border-b border-[var(--color-border)] px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <main ref={mainContentRef} className="flex-1 min-[1280px]:translate-x-5 min-[1281px]:translate-x-10 overflow-y-scroll scrollbar-hide" style={{ scrollBehavior: 'smooth' }}>
                        <div className="min-h-full w-[100%] flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 rounded-2xl relative">
                            <div className="component-container flex-grow w-full z-10 relative">
                                {/* Animated background shapes: made responsive */}
                                <div className="absolute -top-20 -left-20 w-60 h-60 md:w-80 md:h-80 bg-lime-400/5 rounded-full animate-pulse-slow pointer-events-none z-0" />
                                <div className="absolute top-1/4 right-0 w-72 h-72 md:w-96 md:h-96 bg-emerald-500/10 rounded-full blur-[120px] animate-spin-slow pointer-events-none z-0" />
                                <div className="absolute bottom-10 left-1/3 w-32 h-32 md:w-40 md:h-40 bg-sky-500/5 rounded-full animate-pulse-slow pointer-events-none z-0" />
                                <div className="absolute -bottom-20 right-1/4 w-52 h-32 md:w-72 md:h-40 bg-teal-500/5 rounded-lg animate-spin-slow-reverse pointer-events-none z-0" />
                                {ComponentToRender ? (
                                    <ComponentToRender />
                                ) : isComponentsRoot ? (
                                    <AllComponents />
                        ...
                        <div className="w-full flex items-center justify-center pb-4">
                            <h1 className="text-sm md:text-base font-thin text-[var(--color-footer-text-color)]/30" style={{ fontFamily: "Righteous, sans-serif" }}>Made With ❤️ Mohan</h1>
                        </div>
                    </main>
                </div>
            </div>
