...
const GlassCardStackEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import GlassCardStack from './ApexUI-Kit/GlassCardStack/GlassCardStack.jsx';
const App = () => {
  return (
    <div>
      <GlassCardStack />
...
export default App;`,
        tsx: `import GlassCardStack from './ApexUI-Kit/GlassCardStack/GlassCardStack.jsx';
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-black/20 backdrop-blur-md text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                            <CopyBlock
                                text={"npm i apex-ui-kit && npx apex-ui-kit add glass-card-stack"}
                                language="bash"
                                theme={dracula}
                                codeBlock
