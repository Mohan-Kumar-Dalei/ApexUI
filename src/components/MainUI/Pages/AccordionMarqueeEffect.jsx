...
import AccordionMarquee from '../ApexUI-Kit/AccordionMarquee/AccordionMarquee';
    ...
    const componentData = [
        {
            ...
            description: "A visually engaging accordion component where each section reveals a marquee effect on hover, perfect for highlighting key information.",
            icon: Layers,
            previewComponent: (
                <>
                    <AccordionMarquee />
            ...
            usageCode: `
import AccordionMarquee from './ApexUI-Kit/AccordionMarquee/AccordionMarquee.jsx';
const App = () => {
  return (
      <AccordionMarquee
          bgColor='#bbf451'
      ...
      />
            ...
            `,
            installationCode: "npm i apex-ui-kit && npx apex-ui-kit add accordion-marquee",
        },
...
export default AccordionMarqueeEffect;