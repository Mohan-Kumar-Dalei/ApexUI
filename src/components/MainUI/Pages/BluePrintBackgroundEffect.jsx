...
import BluePrintBackground from '../ApexUI-Kit/BluePrintBackground/BluePrintBackground.jsx';
                    ...
                    {activeTab === 'preview' && (
                        <div className="w-full min-h-[60vh] bg-black/30 rounded-md relative overflow-hidden flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-4 transition-opacity duration-500" style={{ opacity: showDemo ? 1 : 0, pointerEvents: showDemo ? 'auto' : 'none' }}>
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold mb-2 text-white text-center drop-shadow-lg">BluePrint Background Effect</h2>
...
// --- MAIN APP COMPONENT ---
const BluePrintBackgroundEffect = () => {
    // To add more component showcases, just add a new object to this array.
    const componentData = [
        {
            id: 'BluePrintBackground',
            name: "Blueprint Background",
            description: "A mesmerizing blueprint background with dynamic grid lines and a futuristic feel.",
            icon: Layers,
            previewComponent: (
                <>
                    <BluePrintBackground
            ...
            props: [
                { prop: 'borderColor', type: 'string', def: 'rgb(98, 116, 142, 0.1)', desc: 'The color of the grid lines.' },
                { prop: 'boxColor', type: 'string', def: '#9ae600', desc: 'The color of the grid boxes while moving mouse pointer.' },
                { prop: 'bgColor', type: 'string', def: '...', desc: 'The background color.' },
                { prop: 'circleColor', type: 'string', def: '...', desc: 'The color of the spotlight circle.' },
            ],
            dependencies: [
            ...
            usageCode: `
import BluePrintBackground From './ApexUI-Kit/BluePrintBackgroundEffect/BluePrintBackground.jsx'
...
export default App;
            ...
            `,
            installationCode: "npm i apex-ui-kit && npx apex-ui-kit add blueprint-background",
        },
...
export default BluePrintBackgroundEffect;