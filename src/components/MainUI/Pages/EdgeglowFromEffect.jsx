...
import EdgeGlowForm from '../ApexUI-Kit/EdgeGlowForm/EdgeGlowFrom.jsx';
...
const EdgeglowFromEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import EdgeGlowForm from './ApexUI-Kit/EdgeGlowForm/EdgeGlowForm.jsx';
const App = () => {
  return (
     <EdgeGlowForm
        GlowColor="purple"
...
export default App;
`,
        tsx: `import EdgeGlowForm from './ApexUI-Kit/EdgeGlowForm/EdgeGlowForm.jsx';
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="bg-black/20 backdrop-blur-md text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                                <CopyBlock
                                    text={"npm i apex-ui-kit && npx apex-ui-kit add edge-glow-form"}
                                    language="bash"
                                    theme={dracula}
                                    codeBlock
