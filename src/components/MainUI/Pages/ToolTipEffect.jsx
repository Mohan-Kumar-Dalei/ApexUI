...
function PropsTable() {
    const allProps = [
        { prop: 'items', type: 'array', def: '[...]', desc: 'Array of data objects for tooltips.' },
    ];
...
export default App;`;
    ...
    let copyText = 'npm i apex-ui-kit && npx apex-ui-kit add tooltip';
            ...
            <div className="max-w-5xl mx-auto py-16 sm:py-24">
                ...
                <header className="text-center mb-12 space-y-4">
                    ...
                    <p className="text-base sm:text-lg text-[var(--color-pages-props-sub-text)] max-w-2xl mx-auto">
                        An animated tooltip that reveals more information on hover, perfect for user profiles and galleries.
                    </p>
                </header>
