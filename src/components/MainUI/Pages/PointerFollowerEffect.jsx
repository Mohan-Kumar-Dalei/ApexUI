...
export default App;`
    ...
    let copyText = `npm i apex-ui-kit && npx apex-ui-kit add pointer-follower`;
            ...
            <div className="max-w-5xl mx-auto py-16 sm:py-24">
                ...
                <div className="w-full bg-[var(--color-pages-bg)] border border-[var(--color-pages-border)] rounded-lg shadow-2xl overflow-hidden">
                    ...
                    <div ref={contentRef} className="p-4 sm:p-6">
                        {activeTab === 'preview' && (
                            <div className="w-full min-h-[60vh] bg-black/30 rounded-md flex flex-col  items-center justify-evenly p-4 pt-18  relative">
                                <PointerFollower
                                    cursorColor="var(--color-pages-side-active-text)"
                                    badgeColor="var(--color-pages-side-active-text)"
                                    badgeTextColor="var(--color-pages-bg)"
                                />
                                <h3 className="text-2xl font-bold mt-18 text-gray-600">Move your cursor</h3>
                            </div>
                        )}
                        {activeTab === 'usage' && (
                            <div>
