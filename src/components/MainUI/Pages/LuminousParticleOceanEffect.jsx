...
import LuminousParticleOcean from '../ApexUI-Kit/LuminousParticleOcean/LuminousParticleOcean';
                    ...
                    {activeTab === 'preview' && (
                        <div className="w-full min-h-[60vh] bg-black/30 rounded-md relative overflow-hidden flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-4 transition-opacity duration-500" style={{ opacity: showDemo ? 1 : 0, pointerEvents: showDemo ? 'auto' : 'none' }}>
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold mb-2 text-white text-center drop-shadow-lg">Luminous Particle Ocean Demo</h2>
...
const KineticThreadsBackgroundEffect = () => {
    ...
    const componentData = [
        {
            id: 'LuminousParticleOcean',
            name: "Luminous Particle Ocean",
            description: "A mesmerizing ocean simulation with luminous particles and dynamic lighting.",
            icon: Layers,
            previewComponent: (
                <>
            ...
            props: [
                { prop: 'sphereCount', type: 'number', def: '100', desc: 'The number of spheres in the ocean.' },
                { prop: 'sphereColor', type: 'string', def: '#00aaff', desc: 'The color of the spheres.' },
                { prop: 'interactionStrength', type: 'number', def: '15', desc: 'The strength of the mouse interaction.' },
                { prop: 'separation', type: 'number', def: '4', desc: 'The separation between spheres.' },
                { prop: 'bgColor1', type: 'string', def: '#010a2d', desc: 'The first background color.' },
                { prop: 'bgColor2', type: 'string', def: '#001133', desc: 'The second background color.' },
            ],
            dependencies: [
...
export default App;
            `,
            installationCode: "npm i apex-ui-kit && npx apex-ui-kit add luminous-particle-ocean",
        },
