...
import Testimonials from '../ApexUI-Kit/Testimonials/Testimonials';

// --- CUSTOM COPY BUTTON (as per your example) ---
...
function PropsTable() {
    const allProps = [
        { prop: 'quote', type: 'string', def: '...', desc: 'The main text content of the testimonial.' },
        { prop: 'avatarUrl', type: 'string', def: '...', desc: 'URL for the author\'s profile image.' },
        { prop: 'authorName', type: 'string', def: '...', desc: 'Name of the person giving the testimonial.' },
        { prop: 'authorRole', type: 'string', def: '...', desc: 'Role or company of the author.' },
        { prop: 'rating', type: 'number', def: '5', desc: 'Star rating from 1 to 5.' },
    ];
...
const App = () => (
        ...
        {
            text: "This is a game-changer. The animations are so smooth, and the component is 
            incredibly easy to customize. Highly recommended!",
            author: "Spider Man",
            title: "Friendly Neighborhood Spider-Man",
            image: "/assets/spiderman.png"
        },
        {
            text: "I was able to integrate this into my project in minutes. The props-based data makes 
            it flexible for any use case.",
            author: "Iron Man",
...
export default App;`;
    ...
    const installationCodeText = "npm i apex-ui-kit && npx apex-ui-kit add testimonials";
    ...
    const testimonialData = [
        {
            text: "This is a game-changer. The animations are so smooth, and the component is incredibly easy to customize. Highly recommended!",
            author: "Spider Man",
            title: "Friendly Neighborhood Spider-Man",
            image: "/assets/spiderman.png"
        },
        {
            text: "I was able to integrate this into my project in minutes. The props-based data makes it flexible for any use case.",
            author: "Iron Man",
            title: "Leader of Stark Industries",
            image: "/assets/ironman.png"
        },
        {
            text: "Fantastic design and flawless execution. The use of Framer Motion adds a professional touch that clients love.",
            author: "HULK",
            title: "Hulk Smash",
            image: "/assets/hulk.png"
        },
        {
            text: "Our user engagement saw a significant boost after implementing this design. It's both beautiful and intuitive.",
            author: "Captain America",
            title: "Leader Of The Avengers",
            ...
            <div className="max-w-5xl mx-auto py-16 sm:py-24">
                ...
                <header className="text-center mb-12 space-y-4">
                    ...
                    <p className="text-base sm:text-lg text-[var(--color-pages-props-sub-text)] max-w-2xl mx-auto">
                        A beautifully designed card component to showcase user testimonials and build social proof.
                    </p>
                </header>
                ...
                <div className="w-full bg-[var(--color-pages-bg)] border border-[var(--color-pages-border)] rounded-lg shadow-2xl overflow-hidden">
                    ...
                    <div ref={contentRef} className="p-4 sm:p-6">
                        {activeTab === 'preview' && (
                            <div className="w-full min-h-[70vh] bg-black/30 rounded-md flex items-center justify-center ">
                                <Testimonials
                                    testimonials={testimonialData}
                                />
                            </div>
