...
import KineticThreadBackground from '../ApexUI-Kit/KineticThreadsBackground/KineticThreadBackground.jsx';
        ...
        <div className="w-full">
            ...
            <div className="w-full bg-[var(--color-pages-bg)] border border-[var(--color-pages-border)] rounded-lg shadow-2xl overflow-hidden">
                ...
                <div ref={contentRef} className="p-4 sm:p-6">
                    {activeTab === 'preview' && (
                        <div className="w-full min-h-[60vh] bg-black/30 rounded-md relative overflow-hidden flex items-center justify-center p-8">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-4 transition-opacity duration-500" style={{ opacity: showDemo ? 1 : 0, pointerEvents: showDemo ? 'auto' : 'none' }}>
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold mb-2 text-white text-center drop-shadow-lg">Kinetic Threads Background Demo</h2>
    ...
    const componentData = [
        {
            ...
            props: [
                { prop: 'speed', type: 'number', def: '1.0', desc: 'The speed of the background animation.' },
                { prop: 'amplitude', type: 'number', def: '1.0', desc: 'The amplitude of the noise effect.' },
                { prop: 'distance', type: 'number', def: '0.5', desc: 'The distance of the noise effect.' },
                { prop: 'color', type: 'string', def: '#a3e635', desc: 'The color of the background.' },
                { prop: 'mouseInteraction', type: 'boolean', def: 'true', desc: 'Whether the background responds to mouse movement.' },
            ],
            dependencies: [
            ...
            usageCode: `
import KineticThreadsBackground From './ApexUI-Kit/KineticThreadsBackground/KineticThreadsBackground.jsx'
...
export default App;
            `,
            installationCode: "npm i apex-ui-kit && npx apex-ui-kit add kinetic-threads-background",
        },
...
export default KineticThreadsBackgroundEffect;