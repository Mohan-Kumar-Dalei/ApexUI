...
import FloatingOrbs from '../ApexUI-Kit/OrbsBackground/FloatingOrbs';
                    ...
                    {activeTab === 'preview' && (
                        <div className="w-full min-h-[50vh] bg-black/30 rounded-md relative overflow-hidden flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-4 transition-opacity duration-500" style={{ opacity: showDemo ? 1 : 0, pointerEvents: showDemo ? 'auto' : 'none' }}>
                                ...
                                <h2 className="text-4xl md:text-5xl font-extrabold mb-2 text-white text-center drop-shadow-lg">Floating Orbs Demo</h2>
...
// --- MAIN APP COMPONENT ---
const FloatingOrbsEffect = () => {
    const componentData = [
        {
            id: 'floatingOrbs',
            name: "Floating Orbs",
            description: "A mesmerizing background effect with floating orbs that react to user interactions.",
            icon: PenTool,
            previewComponent: <FloatingOrbs 
            className="flex items-center justify-center flex-col translate-x-20"
            />,
            props: [
                { prop: 'className', type: 'string', def: '...', desc: 'The CSS class name for the component.' },
                { prop: 'orbColor', type: 'string', def: 'lime-400', desc: 'The color of the floating orbs.' },
                { prop: 'numberOfOrbs', type: 'number', def: '2', desc: 'The number of floating orbs.' },
                { prop: 'containerClassName', type: 'string', def: '...', desc: 'The CSS class name for the container.' },
            ],
            dependencies: [
            ...
            usageCode: `
import OrbsBackground fom './ApexUI-Kit/OrbsBackground/FloatingOrbsBackground.jsx'
const App = ()=> {
            <OrbsBackground
                className="flex items-center justify-center flex-col translate-x-20"
                orbColor="lime-400"
                numberOfOrbs={2}
                containerClassName="absolute inset-0 z-0 w-full h-[60vh]"
            />
}
export default App;
            `,
            installationCode: "npm i apex-ui-kit && npx apex-ui-kit add orbs-background",
        },
