...
function PropsTable({ showAll, setShowAll }) {
    const allProps = [
        { prop: 'children', type: 'ReactNode', def: 'null', desc: 'Content to reveal under the effect.' },
...
function DependenciesList() {
    const dependencies = [
        ...
        { name: 'TailwindCSS', desc: 'A utility-first CSS framework.' },
    ];
    return (
...
const WaterDropRevealEffect = () => {
    ...
    const codeSnippets =
        `import WaterDropReveal from './ApexUI-Kit/WaterDropReveal/WaterDropReveal.jsx';
const App = () => (
  <WaterDropReveal>
    <div className="text-center text-white">
      <h1 className="text-4xl font-bold">Content Revealed</h1>
      <p>This appears after the animation.</p>
    </div>
  </WaterDropReveal>
);
export default App;`
    let copyText = 'npm i apex-ui-kit && npx apex-ui-kit add water-drop-reveal';
        ...
        <div className="text-[var(--color-pages-props-text2)] min-h-screen">
            <div className="max-w-5xl mx-auto  py-16 sm:py-24">
                ...
                <header className="text-center mb-12 space-y-4">
                    <h1 className="text-5xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-[var(--color-pages-props-heading-text)] to-[var(--color-pages-props-heading-text2)] bg-clip-text text-transparent flex items-center justify-center gap-4 whitespace-nowrap">
                        Water Drop Reveal
                    </h1>
                    <p className="text-base sm:text-lg text-[var(--color-pages-props-sub-text)] max-w-2xl mx-auto">
                        A captivating animation where water drops fall and merge to reveal underlying content.
                    </p>
                </header>
                ...
                <div className="w-full bg-[var(--color-pages-bg)] border border-[var(--color-pages-border)] rounded-lg shadow-2xl overflow-hidden">
                    ...
                    <div ref={contentRef} className="p-4 sm:p-6">
                        {activeTab === 'preview' && (
                            <div className="w-full min-h-[60vh] bg-black/30 rounded-md flex items-center justify-center p-4 relative">
                                <WaterDropReavel animationSpeed={0.6}>
                                    <div className="text-center text-white p-4">
                                        <h2 className="text-4xl font-bold drop-shadow-lg">Content Revealed</h2>
                                        <p className="mt-2 text-white/80">This appears after the animation.</p>
                                    </div>
                                </WaterDropReavel>
                            </div>
                        )}
