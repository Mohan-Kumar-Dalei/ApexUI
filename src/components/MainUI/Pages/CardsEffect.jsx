    ...
    const componentData = [
        {
            id: 'BasicCard',
            name: "Basic Card",
            description: "A simple card component with a title, description, and image.",
            icon: Layers,
            previewComponent: (
                <>
                    <BasicCard
            ...
            props: [
                { prop: 'title', type: 'text', def: 'Spider Man', desc: 'The main heading or name of the card.' },
                { prop: 'summary', type: 'text', def: '...', desc: 'A short description or summary for the card.' },
                { prop: 'image', type: 'url', def: '...', desc: 'The image URL for the card.' },
                { prop: 'link', type: 'url', def: '#', desc: 'The external or internal link for the card.' },
            ],
            dependencies: [
