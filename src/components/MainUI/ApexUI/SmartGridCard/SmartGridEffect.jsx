...
import SmartGridCard from './SmartGridCard';
...
const SmartGridEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import SmartGridCard from './ApexUI/SmartGridCard.jsx';
const App = ()=> {
return (
   <div>
      <SmartGridCard 
...
export default App  
`,
        tsx: `import SmartGridCard from './ApexUI/SmartGridCard.jsx';
                ...
                <div className="max-w-5xl mx-auto flex flex-col gap-10 items-center ">
                    ...
                    <div className="w-full max-w-5xl mb-2">
                        ...
                        <div className="bg-[#181824]/50 border border-purple-800 text-green-400 px-4 py-3 font-mono rounded-md relative shadow-md scrollbar-hide">
                            <CopyBlock
                                text={`npm install apex-ui@latest && npx apex-ui add smart-grid`}
                                language="bash"
