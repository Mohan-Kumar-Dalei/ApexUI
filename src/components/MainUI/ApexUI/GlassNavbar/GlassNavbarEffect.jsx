...
const GlassNavBar = () => {
    ...
    const codeSnippets = {
        jsx: `import GlassNavbar from './ApexUI/GlassNavbar';
const App = () => {
  return (
    <div>
        <GlassNavbar
...
export default app; 
        `,
        tsx: `import GlassNavbar from './ApexUI/GlassNavbar';
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-2 ">
                        ...
                        <div className="bg-[#1a1a1d]/20 text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                            <CopyBlock
                                text={`npm install apex-ui@latest && npx apex-ui add glass-navbar`}
                                language="bash"
                                theme={dracula}
                                codeBlock
