...
const GlassProfileEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import GlassProfile from './ApexUI/GlassProfile/GlassProfile';
const App = () => {
  return (
    <div>
      <GlassProfile 
...
export default App;`,
        tsx: `import GlassProfile from './ApexUI/GlassProfile/GlassProfile';
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-black/20 backdrop-blur-md text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                            <CopyBlock
                                text={"npm install apex-ui@latest && npx apex-ui add glass-profile"}
                                language="bash"
                                theme={dracula}
                                codeBlock
