...
const codeSnippets = {
    jsx: `import PointerFollower from './ApexUI/PointerFollower/PointerFollower';
const App = () => (
  <PointerFollower />
);
export default App;`,
    tsx: `import PointerFollower from './ApexUI/PointerFollower/PointerFollower';
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-black/20 backdrop-blur-md text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                            <CopyBlock
                                text={"npm install apex-ui@latest && npx apex-ui add pointer-follower"}
                                language="bash"
                                theme={dracula}
                                codeBlock
