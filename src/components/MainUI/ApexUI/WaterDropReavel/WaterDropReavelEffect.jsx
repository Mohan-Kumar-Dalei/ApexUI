...
import WaterDropReavel from './WaterDropReavel';
...
function PropsTable({ showAll }) {
    const allProps = [
        { prop: 'children', type: 'ReactNode', def: 'null', desc: 'Content to reveal under water drop effect' },
        { prop: 'dropCount', type: 'number', def: '24', desc: 'Number of water drops' },
        { prop: 'dropColor', type: 'string', def: '"#38bdf8"', desc: 'Color of the water drops' },
        { prop: 'background', type: 'string', def: '"#181824"', desc: 'Background color behind the drops' },
        { prop: 'animationSpeed', type: 'number', def: '1.2', desc: 'Speed of the drop animation' },
    ];
...
const codeSnippets = {
    jsx: `import WaterDropReavel from './ApexUI/WaterDropReavel/WaterDropReavel';
const App = () => (
  <WaterDropReavel dropCount={3} dropColor="#38bdf8">
    <div>Your content here</div>
  </WaterDropReavel>
);
export default App;`,
    tsx: `import WaterDropReavel from './ApexUI/WaterDropReavel/WaterDropReavel';
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-black/20 backdrop-blur-md text-green-400 px-4 py-3 font-mono rounded-md border border-purple-600/50 relative scrollbar-hide">
                            <CopyBlock
                                text={"npm install apex-ui@latest && npx apex-ui add water-drop-reveal"}
                                language="bash"
                                theme={dracula}
                                codeBlock
            ...
            <section className="py-8 text-[wheat]">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex-1 w-full h-[60vh] max-md:h-[40vh] rounded-md border border-purple-800 bg-black/20 backdrop-blur-md shadow-2xl flex flex-col gap-6 mx-auto overflow-hidden items-center justify-center">
                        <WaterDropReavel
                            dropCount={3} animationSpeed={0.6}
                        />
                    </div>
                </div>
            </section>
                ...
                <section className="max-w-5xl mx-auto mt-12 mb-8">
                    <div className=" rounded-md border-2 border-dashed border-purple-600/50 shadow-xl p-6 bg-black/20 backdrop-blur-md">
                        <div className="flex items-center gap-4 mb-4 justify-between">
                            ...
                            <PropsShowMoreBtn showAll={showAllProps} setShowAll={setShowAllProps} propCount={5} />
                        </div>
...
export default WaterDropRevealEffect;
