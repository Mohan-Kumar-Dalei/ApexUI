...
const RainBackgroundEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import RainBackground from './ApexUI/RainBackground/RainBackground';
...
export default App;
`,
        tsx: `import RainBackground from './ApexUI/RainBackground/RainBackground';
                ...
                <div className="max-w-6xl mx-auto flex flex-col gap-10 items-center">
                    ...
                    <div className="w-full max-w-5xl mb-2">
                        ...
                        <div className="bg-[#181824]/50 border border-purple-800 text-green-400 px-4 py-3 font-mono rounded-md relative shadow-md scrollbar-hide">
                            <CopyBlock
                                text={`npm install apex-ui@latest && npx apex-ui add rain-background`}
                                language="bash"
