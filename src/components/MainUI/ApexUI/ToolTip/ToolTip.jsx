                ...
                >
                    {hoveredIndex === idx && (
                        <div
                            ...
                            className="absolute bottom-[calc(100%+4px)] z-50 flex flex-col rounded-md items-center border border-purple-500/50 bg-gradient-to-br from-black/90 to-zinc-900/80 px-4 py-2 shadow-2xl backdrop-blur-md"
                    ...
                    <img
                        ...
                        src={item.image}
                        alt={item.name}
                        className="h-14 w-14 object-cover object-center rounded-xl  border-2 border-white shadow-lg transition-transform duration-500"
                        style={{
                            aspectRatio: "1 / 1",
