...
import ScrollMarquee from './ScrollMarquee'; // <-- Make sure this is your ScrollMarquee component
import { useRef } from 'react';
// --- Updated: All current ScrollMarquee props ---
...
const ScrollMarqueeEffect = () => {
    ...
    const codeSnippets = {
        jsx: `import ScrollMarquee from './ApexUI/ScrollMarquee/ScrollMarquee';
import { useRef } from 'react';
const App = () => {
  return (
...
export default App;
`,
        tsx: `import ScrollMarquee from './ApexUI/ScrollMarquee/ScrollMarquee';
import { useRef } from 'react';
                ...
                <div className="flex flex-col gap-10 items-center w-full">
                    ...
                    <div className="w-full mb-2">
                        ...
                        <div className="bg-[#181824]/50 border border-purple-800 text-green-400 px-4 py-3 font-mono rounded-md relative shadow-md scrollbar-hide">
                            <CopyBlock
                                text={`npm install apex-ui@latest && npx apex-ui add scroll-marquee`}
                                language="bash"
